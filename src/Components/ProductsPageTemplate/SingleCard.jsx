          ...
          <div onClick={() => handleProduct(props.data)}>
            <div className="cardTop">
              {props.data.feautured === true ? (
                <span style={{ letterSpacing: ".8px" }}>FEAUTURED</span>
              ) : null}
              {props.data.bestSeller === true ? (
                <span
                  style={{
                    textAlign: "left",
                    color: "green",
            ...
            <div>
              <p>
                <span className="cardMrp">MRP:{props.data.mrp}</span>
                <span>
                  <b>{props.data.price}</b>
                </span>
                <span className="cardOff">{props.data.off}%</span>
              </p>
            </div>
            <div>
